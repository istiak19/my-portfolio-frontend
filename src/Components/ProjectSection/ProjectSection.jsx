...
const ProjectSection = () => {
    return (
        <div className="bg-white dark:bg-black transition-colors duration-300">
          ...
          text-transparent bg-clip-text drop-shadow-md animate-text-gradient mb-5"
                >
                            ...
                            <div className="mt-auto">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                                    <a
                                        ...
                                        className="group relative inline-flex items-center justify-center gap-2 px-6 py-2 rounded-full font-medium 
                      border border-emerald-500/30
                      bg-gradient-to-r from-cyan-400 via-indigo-500 to-fuchsia-500 
                      text-transparent bg-clip-text drop-shadow-md animate-text-gradient 
                      bg-transparent backdrop-blur-md transition-all duration-300 ease-in-out 
                      text-center shadow-md hover:shadow-lg cursor-pointer"
                                    >
                                        Live Demo
                      ...
                      text-center shadow-md hover:shadow-lg cursor-pointer"
                                ...
                                <div className="flex justify-center">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="group relative inline-flex items-center gap-2 px-6 py-2 rounded-full font-medium 
                      border border-emerald-500/30
                      bg-gradient-to-r from-cyan-400 via-indigo-500 to-fuchsia-500 
                      text-transparent bg-clip-text drop-shadow-md animate-text-gradient 
                      bg-transparent backdrop-blur-md transition-all duration-300 ease-in-out 
                ...
                >
                    <Link href="/project">
                        <button className="group relative inline-flex items-center gap-2 px-6 py-2 rounded-full 
              bg-gradient-to-r from-cyan-400 via-indigo-500 to-fuchsia-500 
              text-transparent bg-clip-text drop-shadow-md animate-text-gradient 
