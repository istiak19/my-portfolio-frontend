...
import {
    SiMongodb, SiNextdotjs, SiTypescript, SiPostgresql, SiMongoose, SiRadixui,
    SiRedux
} from "react-icons/si";
    ...
    return (
        <section className="pb-10 px-4 py-10 md:px-0 bg-black">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-5 gap-4 justify-items-center mt-8">
                    {
