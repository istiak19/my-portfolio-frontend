...
const Skills = () => {
    ...
    const renderSkills = (skills) =>
        skills.map((skill, idx) => (
            <motion.div key={idx} variants={item} className="flex flex-col items-center cursor-pointer">
                <div
                    className="w-20 h-20 rounded-2xl p-[2px] bg-gradient-to-r from-pink-500 via-blue-500 to-purple-500 bg-[length:200%_200%] animate-borderSpin transform hover:scale-110 transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.5)] shiny"
                >
    ...
    return (
        <section className="relative bg-black min-h-screen px-4 md:px-0 py-10">
            ...
            <div className="relative max-w-4xl container mx-auto z-10">
                ...
                <h3 className="text-xl font-bold text-white mt-8 mb-6 text-center">Frontend Development Skills</h3>
                <motion.div
                    variants={container}
                    initial="hidden"
                    whileInView="show"
                ...
                <h3 className="text-xl font-bold text-white mt-12 mb-6 text-center">Backend Development Skills</h3>
                <motion.div
                    variants={container}
                    initial="hidden"
                    whileInView="show"
