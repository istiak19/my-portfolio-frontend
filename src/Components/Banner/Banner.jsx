...
const Banner = () => {
    ...
    return (
        <div className="w-full relative bg-white dark:bg-black text-gray-900 dark:text-white overflow-hidden">
            {/* Background Dots */}
            <div className="absolute inset-0 z-0">
                <div className="absolute top-1/8 left-20 w-full h-3/4 bg-dot-pattern opacity-10 dark:opacity-20 mask-left-to-right-fade"></div>
            </div>
            ...
            <div className="flex flex-col-reverse lg:flex-row items-center justify-between container mx-auto px-6 py-16 relative z-10">
                ...
                <div className="lg:w-1/2 space-y-4 md:space-y-6 relative z-20">
                    <h1 className="text-2xl md:text-3xl text-gray-700 dark:text-gray-300 mb-3 tracking-wide leading-snug">
                        Hi there!, I&apos;m{" "}
                        <span className="text-gray-900 dark:text-white font-semibold">Istiak Ahamed</span>
                    </h1>
                        ...
                        <div className="md:hidden">
                            <ul className="flex gap-2 py-1 md:py-5">
                                {links.slice(0, 6).map((link, i) => (
                                    <li key={i} className="banner-list border-2 border-fuchsia-500 p-2 rounded-full">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <button
                            ...
                            className="group relative inline-flex items-center gap-2 px-6 py-2 rounded-full border border-emerald-500/30 backdrop-blur-md bg-gradient-to-r from-cyan-500/10 via-indigo-500/10 to-fuchsia-500/10 text-gray-900 dark:text-white transition-all duration-300 ease-in-out shadow-md hover:shadow-lg cursor-pointer"
                        >
                            <IoCloudDownloadOutline className="text-xl transition-transform duration-300 group-hover:rotate-[-15deg]" />
                            <span className="font-medium group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:via-indigo-500 group-hover:to-fuchsia-500 group-hover:bg-clip-text group-hover:text-transparent">
                                Download Resume
                            </span>
                        ...
                        <button
                            ...
                            className="group relative inline-flex items-center gap-2 px-6 py-2 rounded-full border border-emerald-500/30 backdrop-blur-md bg-gradient-to-r from-cyan-500/10 via-indigo-500/10 to-fuchsia-500/10 text-gray-900 dark:text-white transition-all duration-300 ease-in-out shadow-md hover:shadow-lg cursor-pointer"
                        >
                            <IoEyeOutline className="text-xl transition-transform duration-300 group-hover:rotate-[-15deg]" />
                            <span className="font-medium group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:via-indigo-500 group-hover:to-fuchsia-500 group-hover:bg-clip-text group-hover:text-transparent">
                                View Resume
                            </span>
                            <span className="absolute inset-x-0 -bottom-px h-px bg-gradient-to-r from-transparent via-emerald-500 to-transparent w-3/4 mx-auto" />
